      ...
      body: Consumer<TherapistProvider>(
        builder: (context, therapistProvider, child) {
          return RefreshIndicator(
            onRefresh: therapistProvider.handleGetAllTherapists,
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    FutureBuilder(
                      future: therapistProvider.handleGetAllTherapists(),
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          ...
                          return ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount:
                                therapistProvider.getAllTherapists.length,
                        ...
                        // if (therapistProvider.getAllTherapists.isEmpty) {
                    ...
                    // if (therapistProvider.getAllTherapists.length < 3) ...[
                    //   SizedBox(
